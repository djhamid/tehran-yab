...
export interface Station {
  ...
  colors: string[]; disabled: boolean; address?: string; relations: string[];
}
export type StationsMap = Record<string, Station>;

export interface Line { id: string; name: { fa: string; en: string }; color: string; }
