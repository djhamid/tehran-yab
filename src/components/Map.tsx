...
export default function TehranMap(){
  ...
  useEffect(()=>{if(!mc.current||mapRef.current)return;const map=new maplibregl.Map({container:mc.current,style:'https://basemaps.cartocdn.com/gl/dark-matter-gl-style/style.json',center:[51.389,35.6892],zoom:11});map.addControl(new maplibregl.NavigationControl(),'top-left');
