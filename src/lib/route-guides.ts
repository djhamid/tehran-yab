import { RouteResult, LinesMap } from '@/types/tehgo-metro';
interface PathsMap { [lineId: string]: { paths: { id: string; from: string; to: string; stations: string[]; isBranch?: boolean }[] } }
